...
from vector_pybullet_env import VectorBulletEnv
...
def main():
    running_reward = 10
    # todo time with and without render
    for i_episode in range(5000):
        ...
        print(model.rewards)
        print('Last reward: {}'.format(model.rewards[-1]))
        finish_episode()
        # if i_episode % args.log_interval == 0:
        print('Episode {}\tLast episode return: {:.2f}\tAverage return: {:.2f}'.format(
